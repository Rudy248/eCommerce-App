...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private String productRaandomKey, downloadImageUrl;
    ...
    private void StoreProductInformation() {
        ...
        productRaandomKey=saveCurrentDate + saveCurrentTime;

        StorageReference filePath = ProductImagesRef.child(ImageUri.getLastPathSegment() + productRaandomKey + ".jpg");
    ...
    private void SaveProductInfoToDatabase() {
        ...
        productMap.put("pid", productRaandomKey);
        ...
        ProductRef.child(productRaandomKey).updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
