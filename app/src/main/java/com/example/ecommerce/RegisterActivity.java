...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CreateAccountButton=(Button) findViewById(R.id.button4);
        InputName=(EditText) findViewById(R.id.editTextText);
        InputPhoneNo=(EditText) findViewById(R.id.editTextText2);
        InputPassword=(EditText) findViewById(R.id.editTextText3);
